...
export function Auth0CallbackDec() {
  return applyDecorators(
    ApiOperation({
      summary: 'Auth0 callback',
      description:
        'Handles the callback from Auth0 after successful authentication. Auth0 redirects here with authentication codes. This endpoint exchanges the code for user information and creates/updates the user account.',
    }),
    ApiQuery({
      name: 'code',
      required: false,
